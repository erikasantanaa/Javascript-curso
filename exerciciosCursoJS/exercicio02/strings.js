...
/*
05 .
- Exiba, no console, a string que "summerMessage" (abaixo) armazena, mas com todas as 
letras minúsculas;
...
/*
7 .
- Após a const "harryPotterAuthor" (abaixo), exiba no console a parte "J.K." da 
string "harryPotterAuthor";
...
*/
const reminder = 10 % 3
console.log(`O resto de 10 dividio por três é : ${reminder}`)
